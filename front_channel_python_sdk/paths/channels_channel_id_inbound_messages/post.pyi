...
from front_channel_python_sdk.model.inbound_message import InboundMessage as InboundMessageSchema
...
from front_channel_python_sdk.type.inbound_message import InboundMessage

from ...api_client import Dictionary
from front_channel_python_sdk.pydantic.inbound_message import InboundMessage as InboundMessagePydantic
...
# body param
SchemaForRequestBodyApplicationJson = InboundMessageSchema


request_body_inbound_message = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _import_received_message_mapped_args(
        self,
    ...
    async def _aimport_received_message_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/channels/{channel_id}/inbound_messages',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_inbound_message.serialize(body, content_type)
    ...
    def _import_received_message_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ImportReceivedMessageRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aimport_received_message(
        self,
        sender: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]],
        body: str,
        metadata: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]],
        ...
        **kwargs,
        ...
        args = self._import_received_message_mapped_args(
            body=body,
            sender=sender,
            body=body,
            metadata=metadata,
        ...
        return await self._aimport_received_message_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def import_received_message(
        self,
        sender: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]],
        body: str,
        metadata: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]],
        ...
        return self._import_received_message_oapg(
            body=args.body,
            path_params=args.path,
        )

class ImportReceivedMessage(BaseApi):
    ...
    async def aimport_received_message(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aimport_received_message(
            body=body,
            sender=sender,
            body=body,
            metadata=metadata,
    ...
    def import_received_message(
        ...
        raw_response = self.raw.import_received_message(
            body=body,
            sender=sender,
            body=body,
            metadata=metadata,
